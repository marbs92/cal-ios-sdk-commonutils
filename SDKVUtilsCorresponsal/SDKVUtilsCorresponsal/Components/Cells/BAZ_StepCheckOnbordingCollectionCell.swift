//
//  BAZ_StepCheckObbordingCollectionCell.swift
...
open class BAZ_StepCheckOnbordingCollectionCell: UICollectionViewCell {
    ...
    lazy var itemContent: UIView = {
        ...
        view.backgroundColor = BAZ_ColorManager.greenDarkRW
