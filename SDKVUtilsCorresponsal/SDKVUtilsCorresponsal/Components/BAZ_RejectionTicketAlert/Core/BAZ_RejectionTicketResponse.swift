//
//  BAZ_RejectionTicketResponse.swift
...
public struct BAZ_RejectionTicketResponse: Codable{
    var id                  :   String?
    var digital             :   Bool?
    ...
    public func decrypt() -> BAZ_RejectionTicketResponse {
        
        let response = BAZ_RejectionTicketResponse(
            id: self.id,
