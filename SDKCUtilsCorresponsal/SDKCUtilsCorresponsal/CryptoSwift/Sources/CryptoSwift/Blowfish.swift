...
public final class Blowfish {
  ...
  private let padding: CryptoSwiftPadding
  ...
  public init(key: Array<UInt8>, blockMode: BlockMode = CBC(iv: Array<UInt8>(repeating: 0, count: Blowfish.blockSize)), padding: CryptoSwiftPadding) throws {
