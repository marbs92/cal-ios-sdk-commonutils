//
//  CipherBusinessService.swift
//  AceptaPagoBaz
//
//  Created by David on 15/06/20.
//  Copyright © 2020 Zeus. All rights reserved.
//

import Foundation

open class CipherBusinessService {
    public static let shared = CipherBusinessService()
    typealias Response = ResponseBase<CipherResponse>
    private let path = "/enrolamiento-negocios/seguridad/v1"
